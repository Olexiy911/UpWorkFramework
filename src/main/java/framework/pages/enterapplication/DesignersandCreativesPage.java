...
public class DesignersandCreativesPage extends Page{
	
	public DesignersandCreativesPage(){
		PageFactory.initElements(webDriver, this);
	}	
	
	@FindBy(how = How.XPATH, using = "//h1[1]")
	private WebElement designersandCreativesTitle;
	
	@FindBy(how = How.XPATH, using = "//img[@alt='Upwork']")
	private WebElement upWorkButton;
	
	@Step("Is Web Developers Page opened")
	public boolean isDesignersandCreativesPage(){
		return designersandCreativesTitle.isDisplayed();
	}
