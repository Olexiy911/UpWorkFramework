...
public class SalesMarketingExpertsPage extends Page{
	
	public SalesMarketingExpertsPage(){
		PageFactory.initElements(webDriver, this);
	}	
	
	@FindBy(how = How.XPATH, using = "//h1[1]")
	private WebElement salesMarketingExpertsTitle;
	
	@FindBy(how = How.XPATH, using = "//img[@alt='Upwork']")
	private WebElement upWorkButton;
	
	@Step("Is Web Developers Page opened")
	public boolean isSalesMarketingExperts(){
		return salesMarketingExpertsTitle.isDisplayed();
	}
