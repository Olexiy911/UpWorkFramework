...
public class ProjectDurationOptions extends Page{

	public ProjectDurationOptions() {
	...
	public ProjectDurationOptions selectWorkType(String workType){
