...
public class ExperienceOptions extends Page{
	...
	public ExperienceOptions selectWorkType(String workType){
	...
	public SignUpScreen clickNext(){
		nextButton.click();		
		return PageFactory.initElements(webDriver, SignUpScreen.class);    
	}
	
	@Step("Click Back Button")
	public TimeCommitmentOptions clickBack(){
		backButton.click();		
		return PageFactory.initElements(webDriver, TimeCommitmentOptions.class);    
	}
